                            ...
                            <form method="post" action="peserta_pro_edit.php" enctype="multipart/form-data">
                                ...
                                <?php 
                                    ...
                                    <select class="form-control" Placeholder="Program Studi" name="prodi">
                                        ...
                                        <option value="Teknik Informatika"<?php if($prodi == "Teknik Informatika"){ echo "selected=selected";} ?>>Teknik Informatika</option>
                                        <option value="Sistem Informasi"<?php if($prodi == "Sistem Informasi"){ echo "selected=selected";} ?>>Sistem Informasi</option>
                                    </select>
                                    ...
                                    <select class="form-control" Placeholder="Kelas" name="kelas" required>
                                        <option value="0">--Pilih--</option>
                                        <option value="Reguler Pagi" <?php if($kelas == "Reguler Pagi"){ echo "selected=selected";} ?> >Reguler Pagi</option>
                                        <option value="Reguler Malam" <?php if($kelas == "Reguler Malam"){ echo "selected=selected";} ?> >Reguler Malam</option>
                                        <option value="Sabtu" <?php if($kelas == "Sabtu"){ echo "selected=selected";} ?> >Sabtu</option>
                                        <option value="Minggu" <?php if($kelas == "Minggu"){ echo "selected=selected";} ?> >Minggu</option>
                                    </select>
                            ...
                            <img src="<?php echo "gambar/".$foto;?>" width="120px"><br>
                                ...
                                <label class="form-label"><b>Agama</b></label>
                                        <select class="form-control" Placeholder="Agama" name="agama">
                                            ...
                                            <option value="Budhha"<?php if($agama == "Buddha"){ echo "selected=selected";} ?>>Budhha</option>
                                    ...
                                    <div class="form-floating mb-2">
                                        <input type="date" name="tanggal_lahir" class="form-control" id="floatingInput" placeholder="Tanggal Lahir"
